...
- `service-worker.js` 変更時は `CACHE_NAME` を上げる　ｃｃ
...
```text
TORIAI の開発を手伝ってください。
まず docs/ARCHITECTURE.md / docs/AI_RULES.md / REFACTOR_TODO.md / HANDOFF.md を読んでください。
既存機能を壊さず、担当外の差分を戻さず、計算V2・Column Generation・benchmark・supabase/functions/cg は明示されない限り触らないでください。
